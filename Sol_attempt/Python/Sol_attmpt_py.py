...
Converted from Sol_attmpt_py.ipynb so it can run in a plain virtual environment
without Jupyter. Results are printed to the terminal as pretty-printed sympy
(and as LaTeX for pasting into a document).

Run:
    python Sol_attmpt_py.py
"""
